...
MyColonDataAdenomaDetectionByEndoscopist<-MyColonData[grepl(".*denoma.*|.*adenoc",MyColonData$Histo_ResultTextForFindings),] 
...
MyColonDataHyperplasticDetectionByEndoscopist<-MyColonData[grep(".*yperplastic.*",MyColonData$Histo_ResultTextForFindings),] %>% 
  group_by(Endo_Endoscopist) %>% 
