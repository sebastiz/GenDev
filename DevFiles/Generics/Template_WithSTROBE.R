...
#(MRSP) has emerged as a highly drug-resistant small animal
#veterinary pathogen. Although often isolated from
#outpatients in veterinary clinics, there is concern that
#MRSP follows a veterinary-hospital associated epidemiology.
#This study’s objective was to identify risk factors for
#MRSP infections in dogs and cats in Germany. Clinical
#isolates of MRSP cases (n = 150) and methicillin-susceptible
#S. pseudintermedius (MSSP) controls (n = 133) and
...
#7.0–72.6, P < 0.001) were at higher risk of MRSP infection,
#whereas S. pseudintermedius isolates from ears were
...
#whether to read the article. In STROBE, item 1b recommended
#that authors provide an informative and balanced
...
#which the outcome was measured (e.g. herd, pen or individual)
#is recommended. The presented results should
#include summary outcome measures (e.g. frequency or
#appropriate descriptor of central tendency such as mean or
#median) and, if relevant, a clear description of the association
#direction along with accompanying association measures
#(e.g. odds ratio) and measures of precision (e.g. 95%
#confidence interval) rather than P-value alone. We discourage
#stating that an exposure is or is not significantly associated
#with an outcome without appropriate statistical
#measures. Finally, because many veterinary observational
#studies evaluate multiple potential risk factors, the abstract
#should provide the number of exposure–outcome associations
#tested to alert the end-user to potential type I error in
...
#1. Background/rationale: explain the scientific background
